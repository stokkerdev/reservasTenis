                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <Link :href="route('availabilities.create')" class="bg-tennis-green hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="availability in availabilities" :key="availability.id">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <Link :href="route('availabilities.edit', availability.id)" class="text-indigo-600 hover:text-indigo-900 mr-3">Editar</Link>
...
const confirmDelete = (id) => {
    if (confirm('¿Estás seguro de que quieres eliminar esta disponibilidad?')) {
        form.delete(route('availabilities.destroy', id));
    }
};
</script>
